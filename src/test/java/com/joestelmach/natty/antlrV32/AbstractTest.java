...
import com.joestelmach.natty.antlrV32.CalendarSource;
import com.joestelmach.natty.antlrV32.Parser;
...
public abstract class AbstractTest {
  ...
  protected void validateDateTime(Date date, int month, int day, int year, 
    ...
    Assert.assertEquals("day", day, _calendar.get(Calendar.DAY_OF_MONTH));
    Assert.assertEquals("year", year, _calendar.get(Calendar.YEAR));
    Assert.assertEquals("hours", hours, _calendar.get(Calendar.HOUR_OF_DAY));
